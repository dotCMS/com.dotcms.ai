...
public enum AppKeys {
    ...
    COMPLETION_TEMPERATURE("com.dotcms.ai.completion.model", "1"),
    ...
    EMBEDDINGS_SPLIT_AT_WORDS("com.dotcms.ai.embeddings.split.at.words", "300"),
    EMBEDDINGS_SPLIT_AT_TOKENS("com.dotcms.ai.embeddings.split.at.tokens", "500"),
    EMBEDDINGS_TOKEN_OVERLAP("com.dotcms.ai.embeddings.split.at.tokens", "20"),
    ...
    EMBEDDINGS_THREADS_MAX("com.dotcms.ai.embeddings.threads.max", "20"),
